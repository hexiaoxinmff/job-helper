    ...
    <div className="space-y-lg">
      <div className="rounded-2xl border border-neutral-200 bg-white p-lg dark:border-neutral-800 dark:bg-neutral-900">
        ...
        <textarea
          ...
          className="h-24 w-full resize-y rounded-xl border border-neutral-300 bg-white px-md py-sm text-sm text-neutral-800 outline-none transition-colors focus:ring-2 focus:ring-accent-500 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100"
        />
        ...
        {starMsg && (
          <p className="mt-sm rounded-lg border border-neutral-200 bg-neutral-50 px-md py-sm text-sm text-neutral-600 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-300">
            {starMsg}
          </p>
        )}
        ...
        <button
          ...
          className="mt-md w-full rounded-xl bg-accent-600 py-sm font-medium text-white transition-colors hover:bg-accent-700 disabled:opacity-50"
        >
      ...
      {starResult && (
        <>
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-lg dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <div className="rounded-xl border border-accent-200 bg-accent-50 p-md dark:border-accent-900 dark:bg-accent-950">
          ...
          {starResult.parts.length > 0 && (
            <div className="rounded-2xl border border-neutral-200 bg-white p-lg dark:border-neutral-800 dark:bg-neutral-900">
              <h2 className="mb-md font-semibold text-neutral-800 dark:text-neutral-100">STAR 四步拆解</h2>
              <div className="grid grid-cols-1 gap-sm sm:grid-cols-2">
                {starResult.parts.map((p) => (
                  <div
                    key={p.label}
                    className="group relative rounded-xl bg-neutral-50 px-md py-sm dark:bg-neutral-800"
                  >
          ...
          {starResult.tips.length > 0 && (
            <div className="rounded-2xl border border-warning-200 bg-warning-50 p-lg dark:border-warning-900 dark:bg-warning-950">
              <h2 className="mb-xs font-semibold text-warning-800 dark:text-warning-300">使用建议</h2>
