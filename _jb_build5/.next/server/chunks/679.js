"use strict";exports.id=679,exports.ids=[679],exports.modules={56708:(a,b,c)=>{c.d(b,{F:()=>f});var d=c(26835);let e={info:"border-info-200 bg-info-50 text-info-800 dark:border-info-900 dark:bg-info-950/40 dark:text-info-200",warning:"border-warning-200 bg-warning-50 text-warning-800 dark:border-warning-900 dark:bg-warning-950/40 dark:text-warning-200",success:"border-success-200 bg-success-50 text-success-800 dark:border-success-900 dark:bg-success-950/40 dark:text-success-200",danger:"border-danger-200 bg-danger-50 text-danger-700 dark:border-danger-900 dark:bg-danger-950/40 dark:text-danger-400"};function f({variant:a="info",title:b,icon:c,className:g="",children:h,...i}){return(0,d.jsxs)("div",{role:"danger"===a?"alert":"status",className:`rounded-xl border px-4 py-3 text-sm leading-relaxed ${e[a]} ${g}`,...i,children:[b&&(0,d.jsx)("p",{className:"mb-1 font-medium",children:b}),c?(0,d.jsxs)("div",{className:"flex items-start gap-2",children:[(0,d.jsx)("span",{className:"mt-0.5 shrink-0",children:c}),(0,d.jsx)("div",{className:"min-w-0 flex-1",children:h})]}):h]})}},64725:(a,b,c)=>{c.d(b,{A:()=>e});var d=c(26835);function e({children:a}){return(0,d.jsxs)("p",{className:"mt-8 text-xs text-neutral-400 text-center dark:text-neutral-500",children:["\uD83D\uDD12 ",a]})}},78744:(a,b,c)=>{c.d(b,{B2:()=>f,VH:()=>e,ZF:()=>d});let d=[{id:"zh-CN",label:"中文"},{id:"en",label:"English"}],e=[{id:"fe",industry:{"zh-CN":"互联网",en:"Internet"},role:{"zh-CN":"前端开发工程师",en:"Frontend Engineer"},jd:{"zh-CN":`岗位职责：
...
- Banking internship or sales-related experience is a plus.`}}];function f(a){return e.find(b=>b.id===a)}},95577:(a,b,c)=>{c.d(b,{u:()=>e});let d=process.env.NEXT_PUBLIC_TRACKING_URL||"";function e(a,b){if(d)try{let c=JSON.stringify({event:a,ts:Date.now(),page:"",meta:b??{}});"u">typeof navigator&&navigator.sendBeacon?navigator.sendBeacon(d,new Blob([c],{type:"application/json"})):"u">typeof fetch&&fetch(d,{method:"POST",headers:{"Content-Type":"application/json"},body:c,keepalive:!0}).catch(()=>{})}catch{}}}};